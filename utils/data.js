...
export const data = {
  ...
  entrees: [
    ...
    makeItem("GARLIC C/P", 12.95, entreeCurryOptions),
  ...
  curries: [
    ...
    makeItem("Yellow curry", 15.95, [
      makeOption("Fish", 0, "protein"),
      makeOption("Chicken", -2, "protein"),
      makeOption("Pork", -2, "protein"),
      makeOption("Tofu", -2, "protein"),
      makeOption("TEmpeh", -1, "protein"),
      makeOption("Beef", -1, "protein"),
      makeOption("Shrimp", -1, "protein"),
      makeOption("No protein/VEG", -2, "protein"),
      makeOption("White", 0, "rice"),
      makeOption("Brown", 1, "rice"),
      makeOption("No rice", 0, "rice"),
      makeOption("PxP", 2, "extras"),
  ...
  seafood: [
    ...
    makeItem("SPICY SHRIMP", 12.95, [makeOption("white rice", 0, "rice"), makeOption("brown rice", 1, "rice")]),
