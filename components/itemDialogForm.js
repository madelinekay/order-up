...
const itemDialogForm = (props) => {
    ...
    const { options = [], name, price, category, time, protein = "", rice = "", extras = [], notes = "", stars = 0, quantity = 1 } = props.item; //these may not be in item, and if they are, some fields may not exist 
    const classes = useStylesconst[notes, setNotes] = useState();
